...
1. **Open "context.html"**: Open the `context.html` file in your browser.
...
5. **Update "vocabulary.html"**:
   - Open `vocabulary.html` in a text or code editor.
...
6. **Practice in Browser**:
   - Open `vocabulary.html` in a browser to practice the new words within their context.
